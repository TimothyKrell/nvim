...
local mappings = {
  ...
  s = {
    ...
    f = { "<cmd>Telescope find_files hidden=true no_ignore=true<CR>", "Find files" },
    F = { "<cmd>lua require'telescope.builtin'.find_files(require('telescope.themes').get_dropdown({previewer = false, hidden = true, no_ignore = true}))<CR>", "Find files fast" },
    R = { "<cmd>Telescope registers<cr>", "Registers" },
    k = { "<cmd>Telescope keymaps<cr>", "Keymaps" },
    C = { "<cmd>Telescope commands<cr>", "Commands" },
    v = { "<cmd>lua <cr>", "Commands" },
  },
